...
fn is_executable(path: &Path) -> bool {
    ...
    #[cfg(windows)]
    {
        ...
        let path_ext = env::var("PATHEXT").unwrap_or(".COM;.EXE;.BAT;.CMD;.VBS;.VBE;.JS;.JSE;.WSF;.WSH;.MSC;.PS1".to_string());
        let valid_exts: Vec<String> = path_ext.split(';').map(|s| s.trim().to_lowercase()).collect();
